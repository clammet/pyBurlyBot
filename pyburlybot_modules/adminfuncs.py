...
JOIN_ERRORS = {'ERR_NOSUCHCHANNEL', 'ERR_TOOMANYCHANNELS', 'ERR_NEEDMOREPARAMS',
...
KICK_ERRORS = {'ERR_NEEDMOREPARAMS', 'ERR_NOSUCHCHANNEL', 'ERR_BADCHANMASK',
...
PRIVMSG_ERRORS = {'ERR_NORECIPIENT', 'ERR_NOTEXTTOSEND', 'ERR_CANNOTSENDTOCHAN',
