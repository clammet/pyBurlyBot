...
class BotWrapper:
	...
	def isadmin(self, module: str | None=None, inreactor: bool=False) -> bool | None:
		if inreactor:
	...
	def getOption(self, opt: str, channel: str | bool | None=None, **kwargs: Any) -> Any:
	...
	def getOptions(self, opts: Iterable[str], channel: str | bool | None=None,
		**kwargs: Any) -> list[Any]:
		if not self.event.isPM() and channel is None:
	...
	def setOption(self, opt: str, value: Any, channel: str | bool | None=None,
		inreactor: bool=False, **kwargs: Any) -> None:
		if not self.event.isPM() and channel is None:
